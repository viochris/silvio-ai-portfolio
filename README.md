...
**Silvio Christian, Joe | Data Scientist & AI Engineer**  
...
This project serves as a living laboratory for my work in **Natural Language Processing (NLP)**, **Predictive Modeling**, and **Autonomous AI Agents**. Unlike standard static portfolios, Silvio.AI utilizes **Genkit** as an orchestration layer to communicate with specialized backends.
...
- Includes credentials from **Oracle**, **IBM**, and **Dicoding**.
