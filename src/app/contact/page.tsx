...
export default function ContactPage() {
  return (
    <div className="pt-32 pb-24 px-4 min-h-screen">
      <section id="contact" className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div className="space-y-10 lg:space-y-12">
          ...
          <div className="space-y-8 md:space-y-10">
            {/* Email Contact Item */}
            <div className="flex items-start md:items-center gap-5 md:gap-8 group">
              ...
              <div className="min-w-0 overflow-hidden">
                ...
                <div className="text-lg md:text-xl font-headline font-bold text-white break-words">silvio.christian@example.com</div>
              </div>
            </div>
            ...
            <div className="flex items-start md:items-center gap-5 md:gap-8 group">
              ...
              <div className="min-w-0 overflow-hidden">
                ...
                <div className="text-lg md:text-xl font-headline font-bold text-white break-words">+62 812-3456-7890</div>
              </div>
            </div>
            ...
            <div className="flex items-start md:items-center gap-5 md:gap-8 group">
              ...
              <div className="min-w-0 overflow-hidden">
                ...
                <div className="text-lg md:text-xl font-headline font-bold text-white break-words">Jakarta, Indonesia</div>
              </div>
            </div>
          </div>

          {/* Social Links - Responsive Layout */}
          <div className="pt-8 md:pt-12 border-t border-white/10 flex flex-wrap gap-3 md:gap-4">
